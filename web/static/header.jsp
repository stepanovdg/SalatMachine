...
<div style="background-color: #a0c8ff; padding: 10px;"><img
	src="/ad/resources/ad.png" width="50" height="53" border="0"
	align="left">
<div
...
<c:if test="${sessionScope.authUser!=null}">
	...
	<div style="float: right; margin-right: 5px">[ <a
		href="<c:url value="/doLogout.jsp" />">Выйти</a> ]</div>
	Вы вошли как: <c:out value="${sessionScope.authUser.name}" /> ( <c:out
		value="${sessionScope.authUser.login}" /> )</div>
</c:if>